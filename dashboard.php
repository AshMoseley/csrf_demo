...
if ($csrf_protection) {
    if (empty($_SESSION['csrf_token'])) {
        // token generated by converting a random string of bytes to hexadecimal
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($csrf_protection) {
        // Check if the submitted token matches the one in the current session
...
// Store the current user's email in a variable for easy access
